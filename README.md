...
**Todo List - React** is a Single Page Application which allows the user to have a real-time interface of Todo List. It will allow the users to interact with the list by adding, deleting and updating the tasks.
...
1. Clone using 'git clone git@github.com:ehmaddd/todo-react.git'
2. run 'npm init -y'
...
Feel free to check the [issues page](https://github.com/ehmaddd/todo-react/issues).
...
This project is <a href="https://github.com/ehmaddd/todo-react/blob/feature-branch/LICENSE">MIT</a> licensed.
